...
class  AppHeaderx extends Component {
...
const menu= <View style={{width:"100%",backgroundColor:'#e6e6e6',display:'flex',flexDirection:"column",height:'95%',position:'relative',paddingTop:'11%'} }>
 ...
 style={{marginTop:'10%'}}
  ...
  <Text onPress={() =>{this.props.nav.navigation.navigate('PatientsProfile',{user:this.props.nav.navigation.state.params.user,pass:this.props.nav.navigation.state.params.pass})}} style={{textAlign:'center',fontSize:20,marginTop:'2%'}}>See Your Profile</Text>
 ...
 style={{marginTop:'10%'}}
  ...
  color='#00aced' />
    ...
    <Text  onPress={() =>{this.props.nav.navigation.navigate({routeName:'PatientsMainPage'})}} style={{textAlign:'center',fontSize:20,marginTop:'2%'}}>Home</Text>
 ...
 style={{marginTop:'10%'}}
  ...
  type='font-awesome'
  color='#00aced' />
          <Text onPress={() =>{this.props.nav.navigation.navigate('AboutUsDx',{user:this.props.nav.navigation.state.params.user,pass:this.props.nav.navigation.state.params.pass})}} style={{textAlign:'center',fontSize:20,marginTop:'2%'}}>About us</Text>  
    </View>
<View >
<Icon
 style={{marginTop:'10%'}}
